        ...
        <div className="w-full max-w-md">
          <div className="mb-12 text-center">
            <div className="inline-flex items-center justify-center p-4 bg-indigo-600 rounded-2xl shadow-lg mb-6">
              <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M8 11V7a4 4 0 1 1 8 0v4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>
            ...
            <p className="mt-3 text-on-surface-variant text-base">
              Secure access to your peer-to-peer payment platform.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            <form action={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="login-email" className="block text-[0.75rem] font-medium text-on-surface-variant mb-2 ml-1 uppercase tracking-wide">
                  Email or Phone
                </label>
                <input
                  id="login-email"
              ...
              <div>
                <label htmlFor="login-password" className="block text-[0.75rem] font-medium text-on-surface-variant mb-2 ml-1 uppercase tracking-wide">
                  Password
                </label>
